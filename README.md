...
This repository provides a structured approach to ai audit readiness.
...
Within the Simpleact framework, these five components must work together. This repository focuses on the audit-ready evidence layer of the SimpleAct AI Governance Framework.
