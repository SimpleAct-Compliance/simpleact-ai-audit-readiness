...
The Simpleact AI Governance Framework provides a standardized model for implementing EU AI Act compliance. This repository defines the ai audit readiness layer of that model.
...
A standardized model for AI audit preparation and evidence readiness.
